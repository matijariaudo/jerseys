...
ajax('/api/categories',{},(e)=>{
    ...
    $(".national_menu").html(`<li class="nav-item" onclick="cleanWomenRetro();"><a href="/products/soccer/nationalteams"><img src="assets/images/logos/teams/otherteams.png" alt="" style="height: 25px;"> See all nations</a></li>`)
    qty=0;
    ...
    teams.filter(a=>a.link=='Nba').forEach((e,i) => {
        $(".nba_menu").append(`<li class="nav-item" style="border:1px solid #e8e8e8;border-width:0px 0px 1px 0px;padding-top:10px" onclick="cleanWomenRetro();"><a href="/products/basketball/nba/${e.team.toLowerCase().replaceAll(" ","")}"><img src="assets/images/logos/teams/${e.team.toLowerCase().replaceAll(" ","")}.png" alt="" style="height: 25px;"> ${e.team}</a></li>`)
    })
